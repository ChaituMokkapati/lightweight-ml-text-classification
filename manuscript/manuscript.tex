...
\author*[1]{\fnm{Chaitanya} \sur{Mokkapati}}\email{chaitanyamokkapati@mictech.ac.in}

\author[2]{\spfx{Dr.} \fnm{Prasad} \sur{Devarasetty}}\email{dprasad@mictech.ac.in}

\author[1]{\fnm{Nagulmeera} \sur{Syyed}}\email{sdnagulmeera@mictech.edu.in}
