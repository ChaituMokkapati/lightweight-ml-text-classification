...
\author[2]{\fnm{Nagulmeera} \sur{Syyed}}
...
Experiment code, configuration files, and result CSVs are publicly available at \url{https://github.com/ChaituMokkapati/lightweight-ml-text-classification}. A version-tagged archival release (v1.1.0) is deposited on Zenodo at \url{https://doi.org/10.5281/zenodo.20780973} (DOI: \texttt{10.5281/zenodo.20780973}; concept DOI: \texttt{10.5281/zenodo.20780569}).

\subsection*{Author contribution}
Chaitanya Mokkapati: conceptualization, methodology, software, validation, visualization, writing, original draft. Nagulmeera Syyed: investigation, writing, review and editing. Dr.\ Prasad Devarasetty: supervision, writing, review and editing.
